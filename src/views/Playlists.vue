<template>
	<div class="home">
		...
		>
			<template v-slot:top>
				<v-toolbar flat>
					<v-toolbar-title>Плейлисты</v-toolbar-title>
				</v-toolbar>
			</template>
...
export default {
	...
	methods: {
		async getDataFromApi() {
			...
			await this.$store.dispatch('Playlists/fetchPlaylists', payload)
			this.loading = false
		},
	},
	...
	computed: {
		...mapGetters({
			getActiveItems: 'Playlists/getActiveItems', 
			getCountOfActiveItems: 'Playlists/getCountOfActiveItems'
		}),
	},
}
</script>
